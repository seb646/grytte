          ...
          <div class="md:flex md:items-center md:justify-between">
              ...
              <div class="mt-4 flex md:mt-0 md:ml-4">
                  <span class="hidden sm:block shadow-sm rounded-md float-right">
                      <a href="/posts/create" type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-700 bg-white hover:text-gray-500 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 active:text-gray-800 active:bg-gray-50 transition duration-150 ease-in-out">
              ...
              <thead>
                <tr class="border-t border-gray-200">
                  <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                    <span class="lg:pl-2">Blog Posts</span>
                  </th>
                ...
                @foreach($posts as $post)
                    <tr>
                        ...
                        <div class="flex items-center space-x-3 lg:pl-2">
                            ...
                            <a href="/posts/{{$post->id}}" class="truncate hover:text-gray-600">
                            <span>{{$post->title}}</span>
                            </a>
                        </div>
                        <td class="hidden md:table-cell px-6 py-3 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <?php 
                              $date_unformatted = strtotime($post->updated_at);
                              $date = date("F j, Y", $date_unformatted);
                              echo $date;
                            ?>
                        </td>
                        <td class="pr-6 w-5">
                            <a href="/posts/{{$post->id}}/edit" class="group flex items-center px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" role="menuitem">
