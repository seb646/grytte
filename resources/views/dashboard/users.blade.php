            ...
            <div class="md:flex md:items-center md:justify-between">
                ...
                <div class="mt-4 flex md:mt-0 md:ml-4">
                    <span class="hidden sm:block shadow-sm rounded-md float-right">
                        <a href="/users/create" type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-700 bg-white hover:text-gray-500 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 active:text-gray-800 active:bg-gray-50 transition duration-150 ease-in-out">
                    ...
                    <tr>
                        ...
                        <div class="flex items-center space-x-3 lg:pl-2">
                          <div class="flex items-center">
                            ...
                            <img class="h-10 w-10 rounded-full" src="/storage/images/profiles/{{$user->profile_picture}}">
                            @else
                            <span class="inline-block h-10 w-10 rounded-full overflow-hidden bg-gray-100">
                              <svg class="rounded text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="ml-4">
                              <a href="/users/{{$user->id}}" class="text-sm leading-5 font-medium text-gray-900">
                                {{$user->name}}
                              </a>
                        ...
                        <td class="hidden md:table-cell px-6 py-3 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <?php 
                              $date_unformatted = strtotime($user->created_at);
                        ...
                        <td class="pr-6 w-5">
                          @if(Auth::user()->hasRole('administrator'))
                            <a href="/users/{{$user['id']}}/edit" class="group flex items-center px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" role="menuitem">
                        ...
                        <td class="pr-6 w-5">
                            <a href="/users/{{$user['id']}}" class="group flex items-center px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900" role="menuitem">
